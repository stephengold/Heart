...
Add to the project’s "build.gradle" file:
    ...
    dependencies {
        compile 'com.github.stephengold:Heart:6.4.3+for33'
    }
...
## How to build Heart from source
 ...
 2. Download and extract the Heart source code from GitHub:
   + using Git:
     ...
     + `cd Heart`
     + `git checkout -b latest 6.4.3+for33`
   + using a web browser:
...
[license]: https://github.com/stephengold/Heart/blob/for_jME3.3/license.txt "Heart license"
[log]: https://github.com/stephengold/Heart/blob/for_jME3.3/HeartLibrary/release-notes.md "release log"
